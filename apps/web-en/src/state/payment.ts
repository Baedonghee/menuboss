...
interface IPaymentState {
  ...
  loading: boolean;
  invoiceList: IPaymentInvoiceList[];
  invoiceListLoading: boolean;
  subscriptionLoading: boolean;
  subscription: IPaymentSubscriptionList | null;
  methodList: IPaymentMethodList[];
...
const paymentInvoiceListSelector = selector<IPaymentInvoiceList[]>({
...
const paymentSubscriptionSelector = selector<IPaymentSubscriptionList | null>({
...
const paymentMethodListSelector = selector<IPaymentMethodList[]>({
