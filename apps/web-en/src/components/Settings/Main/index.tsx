        ...
        <Box mt="32px">
          <Box display="flex" alignItems="center" justifyContent="end">
            <Button
              ...
              size="m"
              borderRadius="100px"
              width={pathname === ADMIN_PATH.SETTINGS_TEAM ? '200px' : '140px'}
              onClick={handleAddMemberAndRole}
            >
              <PlusFill width="20" height="20" color={theme.color.white} />
              {pathname === ADMIN_PATH.SETTINGS_TEAM ? 'Add team member' : 'New role'}
            </Button>
          </Box>
            ...
            <>
              ...
              {!memberLoading && !memberList.length && (
                <Empty
                  ...
                  text="No team members are currently saved<br/>Please register by adding a team member"
                />
              )}
            </>
          ) : (
            <>
              ...
              {!roleLoading && !roleList.length && (
                <Empty
                  ...
                  text="There are currently no saved role settings<br/>Please register by adding role settings"
                />
              )}
            </>
          )}
