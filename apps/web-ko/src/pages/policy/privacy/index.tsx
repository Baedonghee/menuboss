  ...
  return (
    <PolicyLayout>
      ...
      <ul className="policy-list mt-80">
        <li>
          (주)오롯코드 ('https://www.menuboss.kr/'이하 '메뉴보스')은(는) 「개인정보 보호법」
          제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할
          수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
        </li>
        <li>
          <ul>
            <li className="title mt-24">제1조(개인정보의 처리목적)</li>
            <li>개인정보의 처리목적 : 일반 개인정보 수집</li>
            <li>수집방법 : 회원가입</li>
            <li>보유근거 : 앱사용</li>
            <li>보유기간 : 3년</li>
            <li>
            ...
            <li className="title mt-24">제2조(개인정보의 제3자 제공에 관한 사항)</li>
            <li>
              ① (주)오롯코드는 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만
              처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및
              제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.
            </li>
            <li>② (주)오롯코드는 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.</li>
            <li>
              <ul>
                <li>개인정보를 제공받는 자 : 메뉴보스</li>
                <li>
                  제공받는 자의 개인정보 이용목적 : 이름, 성별, 로그인ID, 비밀번호, 이메일, 접속 IP
                  정보, 접속 로그, 서비스 이용 기록
                </li>
                <li>제공받는 자의 보유.이용기간: 1년</li>
              </ul>
            </li>
            <li className="title mt-24">제3조(개인정보처리의 위탁에 관한 사항)</li>
            <li>
              ① (주)오롯코드는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를
              위탁하고 있습니다.
            </li>
            <li>
              <ul>
                <li>위탁받는 자 (수탁자) : 개발책임자</li>
                <li>
                  위탁하는 업무의 내용 : 회원제 서비스 이용에 따른 본인확인, 신규 서비스(제품) 개발
            ...
            <li>
              ② (주)오롯코드는 위탁계약 체결시 「개인정보 보호법」 제26조에 따라 위탁업무 수행목적
              외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독,
            ...
            <li className="title mt-24">제4조(개인정보의 파기절차 및 파기방법)</li>
            <li>
              ① (주)오롯코드는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를
              위탁하고 있습니다.
            </li>
            ...
            <li>
              <ul>
                <li>1. 파기절차</li>
                <li>
                  (주)오롯코드는 파기 사유가 발생한 개인정보를 선정하고, (주)오롯코드의 개인정보
            ...
            <li>
              ① 정보주체는 (주)오롯코드에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의
              권리를 행사할 수 있습니다.
            </li>
            <li>
              ② 제1항에 따른 권리 행사는(주)오롯코드에 대해 「개인정보 보호법」 시행령 제41조제1항에
              따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 (주)오롯코드은(는) 이에
              대해 지체 없이 조치하겠습니다.
            </li>
            <li>
            ...
            <li>
              ⑥ (주)오롯코드은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의
              요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.
            </li>
            <li className="title mt-24">제6조(개인정보의 안전성 확보조치에 관한 사항)</li>
            <li>
              (주)오롯코드는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
            </li>
            <li>1. 내부관리계획의 수립 및 시행</li>
            ...
            <li>
              개인정보처리시스템에 접속한 기록을 최소 1년 이상 보관, 관리하고 있으며,다만, 5만명
              이상의 정보주체에 관하여 개인정보를 추가하거나, 고유식별정보 또는 민감정보를 처리하는
              경우에는 2년이상 보관, 관리하고 있습니다. 또한, 접속기록이 위변조 및 도난, 분실되지
              않도록 보안기능을 사용하고 있습니다.
            </li>
            <li>5. 개인정보의 암호화</li>
            <li>
              이용자의 개인정보는 비밀번호는 암호화 되어 저장 및 관리되고 있어, 본인만이 알 수
              있으며 중요한 데이터는 파일 및 전송 데이터를 암호화 하거나 파일 잠금 기능을 사용하는
              등의 별도 보안기능을 사용하고 있습니다.
            </li>
            <li>6. 해킹 등에 대비한 기술적 대책</li>
            <li>
              (주)오롯코드('메뉴보스')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을
              막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된
            ...
            <li>
              ① (주)오롯코드 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를
            ...
            <li className="title mt-24">제8조 (개인정보 보호책임자에 관한 사항)</li>
            <li>
              ① (주)오롯코드 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와
            ...
            <li>
              <ul>
                ...
                <li>직책 :CPO</li>
                <li>직급 :개발책임자</li>
                <li>연락처 :070-4177-9333, help@orotcode.com</li>
              </ul>
            </li>
            ...
            <li>
              <ul>
                ...
                <li>부서명 :개발그룹</li>
                <li>담당자 :신동휘</li>
                <li>연락처 :help@orotcode.com,</li>
              </ul>
            </li>
            <li>
              ② 정보주체께서는 (주)오롯코드 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보
              보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로
              문의하실 수 있습니다. (주)오롯코드 은(는) 정보주체의 문의에 대해 지체 없이 답변 및
              처리해드릴 것입니다.
            </li>
            <li className="title mt-24">제9조 (개인정보의 열람청구를 접수·처리하는 부서)</li>
            <li>
              정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수
              있습니다.
            </li>
            <li>
              (주)오롯코드는 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.
            </li>
            <li>
              <ul>
            ...
            <li className="title mt-24">제10조 (정보주체의 권익침해에 대한 구제방법)</li>
            <li>
            ...
            <li className="title mt-24">제11조 (개인정보 처리방침 변경)</li>
