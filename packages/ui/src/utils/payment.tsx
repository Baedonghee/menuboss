...
export const getCardBrandImage = (brand: string, width: string, height: string) => {
  if (brand === 'amex') {
    ...
    return <Jcb width={width} height={height} />;
    ...
    return <CartesBancaires width={width} height={height} />;
  } else {
